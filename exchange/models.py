...
class Trade(SkeletonU):
    ...
    exchange_oid = models.CharField(_('Exchanges order ID'), help_text=_('Some exchanges returns id of a trade (we have it in format of http://en.wikipedia.org/wiki/UUID for MtGox)'), max_length=36, null=True, blank=True, db_index=True) 
